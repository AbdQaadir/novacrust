...
const CountrySelect = ({
  ...
  return (
    ...
    >
      <PopoverTrigger asChild className="flex-1 h-full ">
        <Button
          type="button"
          variant="outline"
          className="flex min-w-30 h-11 md:h-15 gap-1 rounded-l-[30px] border-r-0 px-3 focus:z-10"
          disabled={disabled}
        >
          {selectedCountry ? (
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="flex h-6 w-6 overflow-hidden rounded-[100%] [&_svg:not([class*='size-'])]:size-full">
